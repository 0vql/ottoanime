...
const Navbar = ({ visit }) => {
  ...
  return (
    <div
      className={`flex flex-col w-[22rem] ${theme.background} ${theme.border.notselected} border-r justify-start items-center border-opacity-50 mt-[4rem] hidden xl:flex`}
    >
