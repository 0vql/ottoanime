        ...
        <div className="p-2 bg-[#141313]">
            ...
            {top.map((anime,i) => (
              <Link key={i} href={`/details/${anime.mal_id}`} >
                <div  style={{filter:"drop-shadow(2px 4px 6px black)"}} className="flex my-1 drop-shadow-2xl p-1 bg-[#141313]">
                    <img className="h-[5rem] w-full max-w-[4rem] rounded-lg object-cover" src={anime?.images.jpg.image_url} alt="test"/>
